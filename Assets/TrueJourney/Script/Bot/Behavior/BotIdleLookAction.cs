...
namespace TrueJourney.BotBehavior
{
    ...
    public partial class BotIdleLookAction : BehaviorAction
    {
        ...
        protected override Status OnUpdate()
        {
            ...
            if (!context.IdleTurningEnabled ||
                context.HasExtinguishOrder ||
                context.HasFollowOrder ||
                context.HasRescueOrder ||
                context.HasMoveOrder ||
                (context.PatrolMovementEnabled && context.HasConfiguredPatrolRoute))
            {
                return Status.Failure;
            }
