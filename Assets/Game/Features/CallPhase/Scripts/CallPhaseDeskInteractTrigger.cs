...
public class CallPhaseDeskInteractTrigger : MonoBehaviour, IInteractable
{
    ...
    private void ResolveReferences(GameObject interactor)
    {
        ...
        if (callInScheduler == null)
        {
            ...
            if (callInScheduler == null)
            {
                callInScheduler = FindAnyObjectByType<CallInScheduler>(FindObjectsInactive.Include);
            }
        }
        ...
        if (mainCameraBrain == null)
        {
            ...
            if (mainCameraBrain == null)
            {
                mainCameraBrain = FindAnyObjectByType<CinemachineBrain>(FindObjectsInactive.Include);
            }
        }
    ...
    private static CinemachineCamera FindCinemachineCamera(string objectName)
    {
        ...
        CinemachineCamera[] cameras = Object.FindObjectsByType<CinemachineCamera>(FindObjectsInactive.Include);
