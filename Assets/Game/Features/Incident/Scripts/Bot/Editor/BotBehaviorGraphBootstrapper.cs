...
namespace TrueJourney.BotBehavior.Editor
{
    ...
    {
        private const string IncidentRootPath = "Assets/Game/Features/Incident";
        private const string BehaviorFolderPath = IncidentRootPath + "/Behavior";
        private const string GraphAssetPath = BehaviorFolderPath + "/Bot Basic Behavior.asset";
        ...
        private static UnityEngine.Object GetOrCreateAuthoringGraphAsset()
        {
            ...
            EnsureFolder("Assets/Game/Features");
            EnsureFolder(IncidentRootPath);
            EnsureFolder(BehaviorFolderPath);
