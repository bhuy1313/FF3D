...
namespace TrueJourney.BotBehavior
{
    ...
    public partial class BotPatrolRouteAction : BehaviorAction
    {
        ...
        protected override Status OnUpdate()
        {
            ...
            if (context.HasExtinguishOrder || context.HasFollowOrder || context.HasRescueOrder || context.HasMoveOrder || !context.PatrolMovementEnabled || !context.HasConfiguredPatrolRoute || !navMeshAgent.enabled || !navMeshAgent.isOnNavMesh)
            {
                return Status.Failure;
            }
