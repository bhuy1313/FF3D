...
public class IncidentVentilationPresetMapSetupTask : IncidentMapSetupTask
{
    ...
    protected override IEnumerator Execute(IncidentMapSetupContext context)
    {
        ...
        {
            context.AddWarning(
                $"{nameof(IncidentVentilationPresetMapSetupTask)}: No ventilation binding matched preset '{context.Payload.ventilationPreset}'.",
                this);
        }
    }
